...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Food Bank Distribution Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Distribution Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "distribution_record_records";
'use strict';
